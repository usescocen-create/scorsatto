  ...
  return (
    ...
    >
      <div className="mx-auto flex h-16 max-w-[1600px] items-center justify-between px-6 md:h-20 md:px-10">
        ...
        <Link
          to="/"
          className="font-serif text-xl md:text-2xl tracking-[0.32em] text-foreground"
        >
          SCORSATTO
        </Link>
        ...
        <button
          onClick={open}
          className="relative flex items-center gap-2 p-2 -mr-2 text-foreground"
      ...
      {/* Mobile menu */}
      {menuOpen && (
        <div className="fixed inset-0 z-50 bg-offwhite md:hidden">
          <div className="flex h-16 items-center justify-between px-6">
            <span className="font-serif text-xl tracking-[0.32em]">
              SCORSATTO
            </span>
            <button
